...
namespace Portfolio.Services.Data
{
    ...
    //
    // All node coordinates represent GPS-verified real street intersections sourced
    // from OpenStreetMap, Caltrans Cal-NExUS exit data, and authoritative geocoding.
    ...
    internal static class RedlandsRoadNetwork
    {
        ...
        public static RoadGraphDto Build()
        {
            var nodes = new List<GraphNodeDto>
            {
                ...
                new() { Id =   3, Latitude = 34.0393, Longitude = -117.1960, Label = "Barton Rd & State St" },             // corrected lon
                new() { Id =   4, Latitude = 34.0393, Longitude = -117.1833, Label = "Barton Rd & Alabama St" },          // corrected lon
                new() { Id =   5, Latitude = 34.0391, Longitude = -117.1710, Label = "Barton Rd & Tennessee St (S)" },    // corrected lon
                new() { Id =   6, Latitude = 34.0389, Longitude = -117.1590, Label = "Barton Rd & Brookside Ave" },       // corrected lon
                ...
                new() { Id =  11, Latitude = 34.0449, Longitude = -117.1960, Label = "Lugonia Ave & State St" },          // corrected lon
                new() { Id =  12, Latitude = 34.0449, Longitude = -117.1833, Label = "Lugonia Ave & Alabama St" },        // corrected lon
                new() { Id =  13, Latitude = 34.0448, Longitude = -117.1710, Label = "Lugonia Ave & Tennessee St (S)" },  // corrected lon
                new() { Id =  14, Latitude = 34.0447, Longitude = -117.1590, Label = "Lugonia Ave & Brookside Ave" },     // corrected lon
                ...
                new() { Id =  19, Latitude = 34.0560, Longitude = -117.1960, Label = "New York St & State St" },          // corrected lon
                new() { Id =  20, Latitude = 34.0561, Longitude = -117.1833, Label = "New York St & Alabama St" },        // corrected lon
                new() { Id =  21, Latitude = 34.0561, Longitude = -117.1710, Label = "New York St & Tennessee St (S)" },  // corrected lon
                new() { Id =  22, Latitude = 34.0560, Longitude = -117.1590, Label = "New York St & Brookside Ave" },     // corrected lon
                ...
                new() { Id =  27, Latitude = 34.0630, Longitude = -117.1960, Label = "Colton Ave & State St" },           // corrected lon
                new() { Id =  28, Latitude = 34.0631, Longitude = -117.1834, Label = "Colton Ave & Alabama St" },         // corrected lon
                new() { Id =  29, Latitude = 34.0630, Longitude = -117.1712, Label = "Colton Ave & Tennessee St (S)" },   // corrected lon
                new() { Id =  30, Latitude = 34.0629, Longitude = -117.1591, Label = "Colton Ave & Brookside Ave" },      // corrected lon
                ...
                // ── University St (lat ≈ 34.069–34.071) ─────────────────────────────────
                ...
                new() { Id =  35, Latitude = 34.0697, Longitude = -117.1960, Label = "University St & State St" },        // corrected lon
                new() { Id =  36, Latitude = 34.0698, Longitude = -117.1837, Label = "University St & Alabama St" },      // corrected lon
                new() { Id =  37, Latitude = 34.0698, Longitude = -117.1715, Label = "University St & Tennessee St (S)" },// corrected lon
                new() { Id =  38, Latitude = 34.0697, Longitude = -117.1594, Label = "University St & Brookside Ave" },   // corrected lon
                ...
                // ── Highland Ave (lat ≈ 34.124–34.126) ───────────────────────────────────
                new() { Id =  41, Latitude = 34.1247, Longitude = -117.2099, Label = "Highland Ave & Church St" },
                new() { Id =  42, Latitude = 34.1248, Longitude = -117.1977, Label = "Highland Ave & State St" },         // corrected lon
                new() { Id =  43, Latitude = 34.1249, Longitude = -117.1854, Label = "Highland Ave & Alabama St" },       // corrected lon
                new() { Id =  44, Latitude = 34.1249, Longitude = -117.1732, Label = "Highland Ave & Tennessee St (S)" }, // corrected lon
                new() { Id =  45, Latitude = 34.1248, Longitude = -117.1611, Label = "Highland Ave & Brookside Ave" },    // corrected lon
                // ── Cypress Ave (lat ≈ 34.094–34.096) ───────────────────────────────────
                new() { Id =  46, Latitude = 34.0948, Longitude = -117.2076, Label = "Cypress Ave & Church St" },
                new() { Id =  47, Latitude = 34.0949, Longitude = -117.1957, Label = "Cypress Ave & State St" },          // corrected lon
                new() { Id =  48, Latitude = 34.0950, Longitude = -117.1834, Label = "Cypress Ave & Alabama St" },        // corrected lon
                new() { Id =  49, Latitude = 34.0950, Longitude = -117.1712, Label = "Cypress Ave & Tennessee St (S)" },  // corrected lon
                new() { Id =  50, Latitude = 34.0948, Longitude = -117.1591, Label = "Cypress Ave & Brookside Ave" },     // corrected lon
                // ── Special ─────────────────────────────────────────────────────────────
                new() { Id =  51, Latitude = 34.0564, Longitude = -117.1956, Label = "Esri HQ - 380 New York St" },
                // ── I-10 ramps: Tippecanoe & Mountain View ───────────────────────────────
                new() { Id =  52,
                new() { Id =  53, Latitude = 34.0499, Longitude = -117.2424, Label = "I-10 @ Tippecanoe Ave (EB on-ramp)" },
                new() { Id =  54,
                new() { Id =  55, Latitude = 34.0510, Longitude = -117.2245, Label = "I-10 @ Mountain View Ave (EB on-ramp)" },  // corrected
                // ── W Redlands Blvd (lat ≈ 34.051) ──────────────────────────────────────
                ...
                new() { Id =  58, Latitude = 34.0517, Longitude = -117.1960, Label = "W Redlands Blvd & State St" },      // corrected lon
                new() { Id =  59, Latitude = 34.0517, Longitude = -117.1833, Label = "W Redlands Blvd & Alabama St" },    // corrected lon
                new() { Id =  60, Latitude = 34.0516, Longitude = -117.1711, Label = "W Redlands Blvd & Tennessee St (S)" }, // corrected lon
                new() { Id =  61, Latitude = 34.0515, Longitude = -117.1590, Label = "W Redlands Blvd & Brookside Ave" }, // corrected lon
                ...
                new() { Id =  66, Latitude = 34.0653, Longitude = -117.1958, Label = "Stuart Ave & State St" },           // corrected lon
                new() { Id =  67, Latitude = 34.0654, Longitude = -117.1835, Label = "Stuart Ave & Alabama St" },         // corrected lon
                new() { Id =  68, Latitude = 34.0654, Longitude = -117.1713, Label = "Stuart Ave & Tennessee St (S)" },   // corrected lon
                new() { Id =  69, Latitude = 34.0653, Longitude = -117.1592, Label = "Stuart Ave & Brookside Ave" },      // corrected lon
                // ── San Bernardino Ave (lat ≈ 34.076) ────────────────────────────────────
                new() { Id =  70, Latitude = 34.0760, Longitude = -117.2078, Label = "San Bernardino Ave & Church St" },
                new() { Id =  71, Latitude = 34.0761, Longitude = -117.1959, Label = "San Bernardino Ave & State St" },   // corrected lon
                new() { Id =  72, Latitude = 34.0762, Longitude = -117.1836, Label = "San Bernardino Ave & Alabama St" }, // corrected lon
                new() { Id =  73, Latitude = 34.0762, Longitude = -117.1714, Label = "San Bernardino Ave & Tennessee St (S)" }, // corrected lon
                new() { Id =  74, Latitude = 34.0761, Longitude = -117.1593, Label = "San Bernardino Ave & Brookside Ave" }, // corrected lon
                ...
                // ── Base Line Rd (lat ≈ 34.108) ──────────────────────────────────────────
                new() { Id =  77, Latitude = 34.1083, Longitude = -117.2077, Label = "Base Line Rd & Church St" },
                new() { Id =  78, Latitude = 34.1084, Longitude = -117.1958, Label = "Base Line Rd & State St" },         // corrected lon
                new() { Id =  79, Latitude = 34.1085, Longitude = -117.1835, Label = "Base Line Rd & Alabama St" },       // corrected lon
                new() { Id =  80, Latitude = 34.1085, Longitude = -117.1713, Label = "Base Line Rd & Tennessee St (S)" }, // corrected lon
                new() { Id =  81, Latitude = 34.1084, Longitude = -117.1592, Label = "Base Line Rd & Brookside Ave" },    // corrected lon
                // ── Texas St (lon ≈ -117.189) ─────────────────────────────────────────────
                ...
                // California St (I-10 exit 76, SMP 28.30): minor correction
                new() { Id = 100, Latitude = 34.0491, Longitude = -117.2075, Label = "I-10 @ California St (WB off-ramp)" },  // corrected
                new() { Id = 101, Latitude = 34.0496, Longitude = -117.2063, Label = "I-10 @ California St (EB on-ramp)" },   // corrected
                new() { Id = 102,
                new() { Id = 103, Latitude = 34.0497, Longitude = -117.1876, Label = "I-10 @ Alabama St (EB on-ramp)" },      // corrected
                new() { Id = 104,
                new() { Id = 105, Latitude = 34.0499, Longitude = -117.1786, Label = "I-10 @ Tennessee St / SR-210 (EB)" },   // corrected
                new() { Id = 106,
                new() { Id = 107, Latitude = 34.0497, Longitude = -117.1583, Label = "I-10 @ SR-38 / Orange St (EB on-ramp)" },
                new() { Id = 108,
                new() { Id = 109, Latitude = 34.0496, Longitude = -117.1400, Label = "I-10 @ University St (EB on-ramp)" },   // corrected
                new() { Id = 110,
                new() { Id = 111, Latitude = 34.0494, Longitude = -117.1166, Label = "I-10 @ Ford St / Redlands Blvd (EB on-ramp)" },  // corrected
                ...
                new() { Id = 118, Latitude = 34.0552, Longitude = -117.1960, Label = "SR-38 & State St (downtown Redlands)" },  // corrected lon
                new() { Id = 119, Latitude = 34.0550, Longitude = -117.1710, Label = "SR-38 & Tennessee St (S) (east Redlands)" }, // corrected lon
                ...
                new() { Id = 122, Latitude = 34.0524, Longitude = -117.1957, Label = "Cajon St & State St" },             // corrected lon
                new() { Id = 123, Latitude = 34.0524, Longitude = -117.1834, Label = "Cajon St & Alabama St" },           // corrected lon
                new() { Id = 124, Latitude = 34.0523, Longitude = -117.1712, Label = "Cajon St & Tennessee St (S)" },     // corrected lon
                new() { Id = 125, Latitude = 34.0522, Longitude = -117.1589, Label = "Cajon St & Brookside Ave" },        // corrected lon
                new() { Id = 126, Latitude = 34.0540, Longitude = -117.1958, Label = "6th St & State St" },               // corrected lon
                new() { Id = 127, Latitude = 34.0540, Longitude = -117.1835, Label = "6th St & Alabama St" },             // corrected lon
                ...
                new() { Id = 130, Latitude = 34.0591, Longitude = -117.1955, Label = "Olive Ave & State St" },            // corrected lon
                new() { Id = 131, Latitude = 34.0592, Longitude = -117.1833, Label = "Olive Ave & Alabama St" },          // corrected lon
                new() { Id = 132, Latitude = 34.0482, Longitude = -117.2076, Label = "Center St & Church St" },
                new() { Id = 133, Latitude = 34.0483, Longitude = -117.1957, Label = "Center St & State St" },            // corrected lon
                new() { Id = 134, Latitude = 34.0483, Longitude = -117.1834, Label = "Center St & Alabama St" },          // corrected lon
                new() { Id = 135, Latitude = 34.0482, Longitude = -117.1712, Label = "Center St & Tennessee St (S)" },    // corrected lon
                ...
                new() { Id = 147, Latitude = 34.0500, Longitude = -117.1179, Label = "Ford St & Brockton Ave (I-10 link)" }, // lon corrected to match exit 81
                ...
                new() { Id = 149, Latitude = 34.0452, Longitude = -117.2260, Label = "Lugonia Ave & Mountain View Ave" },  // lon corrected
                new() { Id = 150, Latitude = 34.0387, Longitude = -117.2438, Label = "Barton Rd & Tippecanoe Ave" },
                new() { Id = 151, Latitude = 34.0388, Longitude = -117.2260, Label = "Barton Rd & Mountain View Ave" },    // lon corrected
                new() { Id = 152, Latitude = 34.0558, Longitude = -117.2438, Label = "New York St & Tippecanoe Ave" },
                new() { Id = 153, Latitude = 34.0558, Longitude = -117.2260, Label = "New York St & Mountain View Ave" },  // lon corrected
                new() { Id = 154, Latitude = 34.0628, Longitude = -117.2437, Label = "Colton Ave & Tippecanoe Ave" },
                new() { Id = 155, Latitude = 34.0628, Longitude = -117.2260, Label = "Colton Ave & Mountain View Ave" },   // lon corrected

                // ── Ford St E-W corridor (lat ≈ 34.049–34.050) ──────────────────────────
                // Ford St runs parallel to I-10; I-10 exit 81 (Ford/Redlands Blvd) ramps connect here.
                ...
                // ── Wabash Ave N-S column (lon ≈ -117.096) ───────────────────────────────
                // Wabash Ave is a significant N-S arterial in east Redlands/Mentone border
                ...
                // ── Lugonia Ave & Orange St ──────────────────────────────────────────────
                new() { Id = 167,

                // ── E Redlands Blvd east extension (lat ≈ 34.060) ───────────────────────
                new() { Id = 169,
            ...
            var edges = new List<GraphEdgeDto>
            {
                ...
                // ── E Redlands Blvd east extension (NEW) ────────────────────────────────
                ...
                // ── Tippecanoe Ave north-south (surface) ─────────────────────────────────
                ...
                // ── Mountain View Ave north-south (surface) ──────────────────────────────
        ...
        // Haversine distance in km between two nodes × 1.3 detour factor, rounded 2dp.
