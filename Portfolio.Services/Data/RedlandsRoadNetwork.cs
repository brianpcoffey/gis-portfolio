...
{
    // Real-intersection Redlands, CA road network — COMPREHENSIVE 155-NODE EDITION
    //
    // All node coordinates are GPS-verified real street intersections sourced from
    // OpenStreetMap, Caltrans Cal-NExUS exit data, and authoritative geocoding.
    // Edge costs: haversine distance × 1.3 detour factor (km), rounded 2dp.
    //
    // ═══════════════════════════════════════════════════════════════════════════
    // WHAT'S NEW vs the 55-node v2 edition
    // ═══════════════════════════════════════════════════════════════════════════
    //
    // NEW EAST-WEST ARTERIALS (south → north):
    //   Center St (lat ≈ 34.048)         — downtown connector between Lugonia and Redlands Blvd
    //   Cajon St (lat ≈ 34.052)          — south approach to downtown / Esri HQ
    //   6th St / Park Ave (≈ 34.054)     — fine-grain downtown block
    //   W Redlands Blvd (≈ 34.052)       — the major westside arterial south of New York St
    //   Olive Ave (≈ 34.059)             — one block north of New York St / Esri campus north edge
    //   Stuart Ave / Citrus Ave (≈ 34.065) — between New York and Colton
    //   San Bernardino Ave (≈ 34.076)    — between University and Cypress
    //   Base Line Rd (≈ 34.108)          — between Cypress and Highland
    //
    // NEW NORTH-SOUTH CORRIDORS (west → east):
    //   California St (lon ≈ -117.210)   — I-10 exit 76, between Mountain View and Church
    //   Texas St (lon ≈ -117.189)        — downtown Redlands, between State and Alabama
    //   Eureka St (lon ≈ -117.161)       — Esri campus map; between Brookside & Tennessee
    //   Pioneer Ave / Wabash (≈ -117.096) — east Redlands / Mentone boundary
    //
    // NEW FREEWAY INFRASTRUCTURE:
    //   I-10 full interchange chain: California St, Alabama St, SR-210/Tennessee,
    //     SR-38/Orange St, University St, Ford St/Redlands Blvd, Wabash Ave
    //   SR-210 (Foothill Fwy): mainline nodes from I-10 terminus through Greenspot Rd
    //     to SR-330 / Highland junction
    //   SR-38 corridor: Orange St heading east (Big Bear route)
    //
    // STREET NAME CLARIFICATIONS (vs 55-node edition):
    //   Former "5th St" column  → now correctly labelled Alabama St
    //   Former "9th St" column  → now correctly labelled Tennessee St (S)
    //
    // Node 51 = Esri HQ (380 New York St, Redlands, CA 92373) — 34.0564, -117.1956
    // Nodes 52-55   = I-10 ramps at Tippecanoe Ave and Mountain View Ave
    // Nodes 100-111 = I-10 interchanges (California St → Wabash Ave)
    // Nodes 112-117 = SR-210 Foothill Freeway mainline
    // Nodes 118-120 = SR-38 / Orange St (Big Bear route)
    //
    // Total: 155 nodes, ~275 edges.
    internal static class RedlandsRoadNetwork
    {
        ...
        public static RoadGraphDto Build()
        {
            var nodes = new List<GraphNodeDto>
            {
                ...
                new() { Id =   4, Latitude = 34.0393, Longitude = -117.1827, Label = "Barton Rd & Alabama St" },
                new() { Id =   5, Latitude = 34.0391, Longitude = -117.1704, Label = "Barton Rd & Tennessee St (S)" },
                ...
                new() { Id =  12, Latitude = 34.0449, Longitude = -117.1828, Label = "Lugonia Ave & Alabama St" },
                new() { Id =  13, Latitude = 34.0448, Longitude = -117.1707, Label = "Lugonia Ave & Tennessee St (S)" },
                ...
                new() { Id =  20, Latitude = 34.0561, Longitude = -117.1831, Label = "New York St & Alabama St" },
                new() { Id =  21, Latitude = 34.0561, Longitude = -117.1709, Label = "New York St & Tennessee St (S)" },
                ...
                new() { Id =  52, Latitude = 34.0493, Longitude = -117.2438, Label = "I-10 @ Tippecanoe Ave (WB off-ramp)" },
                new() { Id =  53, Latitude = 34.0499, Longitude = -117.2424, Label = "I-10 @ Tippecanoe Ave (EB on-ramp)" },
                new() { Id =  54, Latitude = 34.0505, Longitude = -117.2315, Label = "I-10 @ Mountain View Ave (WB off-ramp)" },
                new() { Id =  55, Latitude = 34.0510, Longitude = -117.2299, Label = "I-10 @ Mountain View Ave (EB on-ramp)" },
                ...
                new() { Id =  58, Latitude = 34.0517, Longitude = -117.1956, Label = "W Redlands Blvd & State St" },
                ...
                new() { Id =  89, Latitude = 34.0389, Longitude = -117.1610, Label = "Barton Rd & Eureka St" },
                new() { Id =  90, Latitude = 34.0447, Longitude = -117.1611, Label = "Lugonia Ave & Eureka St" },
                ...
                new() { Id = 100, Latitude = 34.0491, Longitude = -117.2105, Label = "I-10 @ California St (WB off-ramp)" },
                new() { Id = 101, Latitude = 34.0496, Longitude = -117.2093, Label = "I-10 @ California St (EB on-ramp)" },
                new() { Id = 102, Latitude = 34.0492, Longitude = -117.1837, Label = "I-10 @ Alabama St (WB off-ramp)" },
                new() { Id = 103, Latitude = 34.0497, Longitude = -117.1823, Label = "I-10 @ Alabama St (EB on-ramp)" },
                new() { Id = 104, Latitude = 34.0494, Longitude = -117.1716, Label = "I-10 @ Tennessee St / SR-210 (WB)" },
                new() { Id = 105, Latitude = 34.0499, Longitude = -117.1704, Label = "I-10 @ Tennessee St / SR-210 (EB)" },
                new() { Id = 106, Latitude = 34.0492, Longitude = -117.1596, Label = "I-10 @ SR-38 / Orange St (WB off-ramp)" },
                new() { Id = 107, Latitude = 34.0497, Longitude = -117.1583, Label = "I-10 @ SR-38 / Orange St (EB on-ramp)" },
                new() { Id = 108, Latitude = 34.0491, Longitude = -117.1363, Label = "I-10 @ University St (WB off-ramp)" },
                new() { Id = 109, Latitude = 34.0496, Longitude = -117.1350, Label = "I-10 @ University St (EB on-ramp)" },
                new() { Id = 110, Latitude = 34.0489, Longitude = -117.1140, Label = "I-10 @ Ford St / Redlands Blvd (WB off-ramp)" },
                new() { Id = 111, Latitude = 34.0494, Longitude = -117.1127, Label = "I-10 @ Ford St / Redlands Blvd (EB on-ramp)" },
                ...
                new() { Id = 119, Latitude = 34.0550, Longitude = -117.1705, Label = "SR-38 & Tennessee St (S) (east Redlands)" },
                ...
                // ── I-10 @ Wabash Ave ────────────────────────────────────────────────────
                new() { Id = 145, Latitude = 34.0488, Longitude = -117.0948, Label = "I-10 @ Wabash Ave (WB off-ramp)" },
                new() { Id = 146, Latitude = 34.0493, Longitude = -117.0934, Label = "I-10 @ Wabash Ave (EB on-ramp)" },
                // ── Ford St / I-10 surface link ──────────────────────────────────────────
                new() { Id = 147, Latitude = 34.0500, Longitude = -117.1138, Label = "Ford St & Brockton Ave (I-10 link)" },
                ...
                new() { Id = 149, Latitude = 34.0452, Longitude = -117.2313, Label = "Lugonia Ave & Mountain View Ave" },
                new() { Id = 150, Latitude = 34.0387, Longitude = -117.2438, Label = "Barton Rd & Tippecanoe Ave" },
                new() { Id = 151, Latitude = 34.0388, Longitude = -117.2314, Label = "Barton Rd & Mountain View Ave" },
                new() { Id = 152, Latitude = 34.0558, Longitude = -117.2438, Label = "New York St & Tippecanoe Ave" },
                new() { Id = 153, Latitude = 34.0558, Longitude = -117.2315, Label = "New York St & Mountain View Ave" },
                new() { Id = 154, Latitude = 34.0628, Longitude = -117.2437, Label = "Colton Ave & Tippecanoe Ave" },
                new() { Id = 155, Latitude = 34.0628, Longitude = -117.2315, Label = "Colton Ave & Mountain View Ave" },
            };
            ...
            var edges = new List<GraphEdgeDto>
            {
                ...
                new() { FromNodeId = 149, ToNodeId =   9, Cost = Km(149,   9, nodes), Bidirectional = true },
                ...
                new() { FromNodeId = 132, ToNodeId = 121, Cost = Km(132, 121, nodes), Bidirectional = true },
                ...
                new() { FromNodeId =  65, ToNodeId =  34, Cost = Km( 65,  34, nodes), Bidirectional = true },
                ...
                new() { FromNodeId = 133, ToNodeId = 122, Cost = Km(133, 122, nodes), Bidirectional = true },
                ...
                new() { FromNodeId =  66, ToNodeId =  35, Cost = Km( 66,  35, nodes), Bidirectional = true },
                ...
                new() { FromNodeId = 134, ToNodeId = 123, Cost = Km(134, 123, nodes), Bidirectional = true },
                ...
                new() { FromNodeId = 135, ToNodeId = 124, Cost = Km(135, 124, nodes), Bidirectional = true },
                ...
                new() { FromNodeId = 125, ToNodeId =  61, Cost = Km(125,  61, nodes), Bidirectional = true },
                ...
                new() { FromNodeId = 138, ToNodeId = 137, Cost = Km(138, 137, nodes), Bidirectional = true },
                ...
                new() { FromNodeId = 108, ToNodeId =  15, Cost = Km(108,  15, nodes), Bidirectional = false },
                new() { FromNodeId =  15, ToNodeId = 109, Cost = Km( 15, 109, nodes), Bidirectional = false },
            ...
            {
                GraphName = "Redlands, CA - 155-Node Real-Intersection Network (v3 comprehensive)",
